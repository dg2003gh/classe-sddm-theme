...
RowLayout {
    ...
    property int fontSize: PlasmaCore.Theme.defaultFont.pointSize - 5
    ...
    PW.BatteryIcon {
        ...
        Layout.preferredHeight: Math.max(PlasmaCore.Units.iconSizes.smallMedium, batteryLabel.implicitHeight)
