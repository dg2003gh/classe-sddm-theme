...
PlasmaCore.ColorScope {
    ...
    MouseArea {
        ...
        RowLayout {
            ...
            height: PlasmaCore.Units.iconSizeHints.panel / 1.35
            ...
            PlasmaComponents3.ToolButton {
                ...
                checkable: true
                onToggled: menu.isOpen = !menu.isOpen
            ...
            RowLayout {
                ...
                ActionButton {
                    ...
                    onClicked: mainStack.currentItem == mainStack.initialItem ?  mainStack.push(userPromptComponent) : mainStack.pop(null)
                    enabled: true
        ...
        QQC2.StackView {
            ...
            height: root.height + PlasmaCore.Units.gridUnit * 1
            ...
            initialItem: Login {
                ...
                showUserList: {
                   ...
                   return true //userListModel.count <= userListModel.disableAvatarsThreshold
                }
        ...
        RowLayout {
            ...
            anchors {
                ...
                left: parent.left
                right: parent.right
                margins: PlasmaCore.Units.largeSpacing * 5
            }
